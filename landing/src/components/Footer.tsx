      ...
      <div className="max-w-7xl mx-auto px-6 pt-12 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2 list-none">
              ...
              <li>
                <Link href="/#faq" className="text-sm text-navy-300 hover:text-gold-400 transition-colors no-underline">
                  FAQ
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="text-sm text-navy-300 hover:text-gold-400 transition-colors no-underline">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-sm text-navy-300 hover:text-gold-400 transition-colors no-underline">
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link href="/cookies" className="text-sm text-navy-300 hover:text-gold-400 transition-colors no-underline">
                  Cookie Policy
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-6 border-t border-navy-800 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-navy-500">
            © {year} Patriot 7Six LLC dba Patriot Ops Center. All rights reserved.
          </p>
          <div className="flex items-center gap-2 text-xs text-navy-500">
            <svg viewBox="0 0 19 10" aria-hidden="true" className="h-[14px] w-[26px] shrink-0 rounded-[1px] ring-1 ring-black/20">
